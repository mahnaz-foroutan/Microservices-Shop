...
namespace Discount.Grpc.Services
{
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public override async Task<CouponModel> GetDiscount(GetDiscountRequest request, ServerCallContext context)
        {
            ...
            if (coupon == null)
            {
                throw new RpcException(new Status(StatusCode.NotFound, $"Discount with product id {request.ProductId} is not found"));
            }

            _logger.LogInformation("Discount is Retrived for Product Id");
           ;
        ...
        public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
        {
            ...
            _logger.LogInformation($"discount is successfully updated for product : {coupon.ProductId}");
