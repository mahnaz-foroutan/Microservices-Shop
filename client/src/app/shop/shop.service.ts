...
export class ShopService {
  ...
  getProducts(useCache = true): Observable<Pagination<Product[]>> {
    ...
    return this.http.get<Pagination<Product[]>>(this.baseUrl + 'catalog', {params}).pipe(
      map(response => {
  ...
  getBrands() {
    ...
    return this.http.get<Brand[]>(this.baseUrl + 'catalog/brands').pipe(
  ...
  getTypes() {
    ...
    return this.http.get<Type[]>(this.baseUrl + 'catalog/types').pipe(
